...
h.LayoutType='radial'; %网络布局类型为平衡结构
bh1=[1:8,11:14,17,18,20,22]; bh2=setdiff([1:34],bh1);
set(h.Nodes(bh2),'shape','circle'); %修改顶点形状
set(h.Nodes(b1),'shape','circle','Color',[0.1 1 0.2]); %修改顶点填充颜色
set(h.Nodes(b2),'shape','circle','Color',[0.1 0.9 0.8]); %修改顶点填充颜色
set(h.Edges,'LineColor',[0.8 0.8 0.9]); %为了将来打印清楚，边画成黑色
set(h.Edges,'LineWidth',1);  %线型宽度设置为1.5
dolayout(h) %刷新图形
