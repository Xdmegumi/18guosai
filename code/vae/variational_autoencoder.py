...
(x_train, y_train), (x_test, y_test) = mnist.load_data('minst.npz')
...
plt.colorbar()
plt.show()
fig.savefig('z_{}.png'.format(use_loss),dpi=600)
...
plt.show()
fig.savefig('x_{}.png'.format(use_loss),dpi=600)
...
plt.imshow(figure, cmap='Greys_r')
plt.show()
fig.savefig('i_{}.png'.format(use_loss),dpi=600)
