...
\begin{tikzpicture}[
  ...
  \draw[to] (mydata) -- node[midway,above] {equation}
   node[midway,below] {$\sqrt{(x-y)\Sigma^{-1}}$} (daq);
\end{tikzpicture}
\end{center}
\end{document}